---
title: "PlumaFill — Fill-In Word Puzzle App"
status: "In progress (MVP)"
tech: ["Swift", "SwiftUI"]
type: "Solo product build"
permalink: /projects/plumafill/
---
...
PlumaFill is a native iOS fill-in word puzzle app — think crossword vibes, minus the clues — focused on clean UX, offline play, and not over-engineering the fun out of it.
...
- ✅ **Milestone 0:** Xcode project boots cleanly in the simulator (“Hello, world!”) with a locked baseline commit
...
> Coming soon — once the app does something more exciting than politely existing.
...
- **Repo:** (to be added)
- **Blog series:** Follow posts tagged `plumafill` for build notes, decisions, and lessons learned

---

*If you’re looking for the running narrative — what broke, what worked, and why decisions were made — the blog is where that story lives.*
